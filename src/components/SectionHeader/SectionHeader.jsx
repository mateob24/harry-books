...
export const SectionHeader = () => {
  return (
    <>
        <section className='harry-intro w-full flex flex-col items-center justify-center'>
            ...
            <h2 className='text-4xl font-extrabold'>¡Conoce Hogwarts, conoce Harry Potter en HarryBooks!</h2>
        </section>
    </>
  )
}
